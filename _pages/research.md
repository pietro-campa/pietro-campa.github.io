...
This paper investigates the influence of exposure to schoolmates from diffrent family backgrounds on children’s intergenerational mobility. Using administrative data on Danish students born between 1980 and 1988, I find that exposure to highschool schoolmates from higher socioeconomic backgrounds significantly increases children’s lifetime earnings, with the effect being larger for students from disadvantaged families. Leveraging on within-school variation, I find that a 20 percentiles increase in schoolmates’ parental earnings results in a 4.2% average increase
in lifetime earnings for children from parents at the bottom decile of the earnings’ distribution. When educational attainment and labor market participation are considered, I find that children exposed to better peers in high school increase their chances to be employed in high paying occupations and to cover managerial positions. Overall, these results provide evidence on the joint nature of social mobility: children climb the earnings’ ladder with respect of their parents, and in doing so, their peers play a crucial role.

"**[Born to be (sub)Prime: An Exploratory Analysis](https://cepr.org/publications/dp17847).**"  
*(Joint with Helena Bach, [Giacomo De Giorgi](https://sites.google.com/site/giacomodegiorgi/), [Jaromir Nosal](https://www.jaromirnosal.net/) and [Davide Pietrobon](https://sites.google.com/view/davide-pietrobon/home).)*  the **AEA Papers and Proceedings**, 2023, 113: 166-71. 
